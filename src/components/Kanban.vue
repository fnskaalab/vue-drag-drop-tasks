        ...
        <div class="flex flex-grow px-10 mt-4 space-x-6 overflow-auto">
            <div class="flex flex-col flex-shrink-0 w-72">
                ...
                <div class="flex flex-col pb-2 overflow-auto">
                    <div class="relative flex flex-col items-start p-4 mt-3 bg-white rounded-lg cursor-grab bg-opacity-90 group hover:bg-opacity-100"
                        v-for="(item,index) in todos.backlog" :key="index" draggable="true"
                        ...
                        <span
                            class="flex items-center h-6 px-3 text-xs font-semibold text-pink-500 bg-pink-100 rounded-full">{{
                                item.category }}</span>
                        <h4 class="mt-3 text-sm font-medium">{{ item.content }}</h4>
                        <div class="flex items-center w-full mt-3 text-xs font-medium text-gray-400">
                            <div class="flex items-center">
                                ...
                                <span class="ml-1 leading-none">{{ item.createdAt }}</span>
                            </div>
                            <div class="relative flex items-center ml-4">
                                ...
                                <span class="ml-1 leading-none">{{ item.comments }}</span>
                            </div>
                            <div class="flex items-center ml-4">
                                ...
                                <span class="ml-1 leading-none">{{ item.savings }}</span>
                            </div>
            ...
            <div class="flex flex-col flex-shrink-0 w-72">
                ...
                <div class="flex flex-col pb-2 overflow-auto">
                    <div class="relative flex flex-col items-start p-4 mt-3 bg-white rounded-lg cursor-pointer bg-opacity-90 group hover:bg-opacity-100"
                        v-for="item in todos.ready" :key="item.id" draggable="true">
                        <button
                            class="absolute top-0 right-0 flex items-center justify-center hidden w-5 h-5 mt-3 mr-2 text-gray-500 rounded hover:bg-gray-200 hover:text-gray-700 group-hover:flex">
                            <svg class="w-4 h-4 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                                fill="currentColor">
            ...
            <div class="flex flex-col flex-shrink-0 w-72">
                ...
                <div class="flex flex-col pb-2 overflow-auto">
                    <div class="relative flex flex-col items-start p-4 mt-3 bg-white rounded-lg cursor-pointer bg-opacity-90 group hover:bg-opacity-100"
                        v-for="item in todos.doing" :key="item.id" draggable="true">
                        <button
                            class="absolute top-0 right-0 flex items-center justify-center hidden w-5 h-5 mt-3 mr-2 text-gray-500 rounded hover:bg-gray-200 hover:text-gray-700 group-hover:flex">
                            <svg class="w-4 h-4 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                                fill="currentColor">
            ...
            <div class="flex flex-col flex-shrink-0 w-72">
                ...
                <div class="flex flex-col pb-2 overflow-auto">
                    <div class="relative flex flex-col items-start p-4 mt-3 bg-white rounded-lg cursor-pointer bg-opacity-90 group hover:bg-opacity-100"
                        v-for="item in todos.review" :key="item.id" draggable="true">
                        <button
                            class="absolute top-0 right-0 flex items-center justify-center hidden w-5 h-5 mt-3 mr-2 text-gray-500 rounded hover:bg-gray-200 hover:text-gray-700 group-hover:flex">
                            <svg class="w-4 h-4 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                                fill="currentColor">
            ...
            <div class="flex flex-col flex-shrink-0 w-72">
                ...
                <div class="flex flex-col pb-2 overflow-auto">
                    <div class="relative flex flex-col items-start p-4 mt-3 bg-white rounded-lg cursor-pointer bg-opacity-90 group hover:bg-opacity-100"
                        v-for="item in todos.deploy" :key="item.id" draggable="true">
                        <button
                            class="absolute top-0 right-0 flex items-center justify-center hidden w-5 h-5 mt-3 mr-2 text-gray-500 rounded hover:bg-gray-200 hover:text-gray-700 group-hover:flex">
                            <svg class="w-4 h-4 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                                fill="currentColor">
            ...
            <div class="flex flex-col flex-shrink-0 w-72">
                ...
                <div class="flex flex-col pb-2 overflow-auto">
                    <div class="relative flex flex-col items-start p-4 mt-3 bg-white rounded-lg cursor-pointer bg-opacity-90 group hover:bg-opacity-100"
                        v-for="(item,index) in todos.backlog" :key="item.id" >
                        <button
                            class="absolute top-0 right-0 flex items-center justify-center hidden w-5 h-5 mt-3 mr-2 text-gray-500 rounded hover:bg-gray-200 hover:text-gray-700 group-hover:flex">
                            <svg class="w-4 h-4 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                                fill="currentColor">
    ...
    methods: {
        ...
        onDrop(event, index) {
            ...
            if (draggedItemIndex !== index) {
                this.moveItem(draggedItemIndex, index);
            }
        },
        moveItem(fromIndex, toIndex) {
            const items = [...this.todos.backlog];
            const itemToMove = items.splice(fromIndex, 1)[0];
            items.splice(toIndex, 0, itemToMove);
            this.todos.backlog = items;
        }
    }
}
</script>